<?php
require_once("../../TableExample/LoadHelper.php");
spl_autoload_register(array("TableExample\LoadHelper", "LoadModule"));

use TableExample\DbSet;
use TableExample\DataSourceLoader;

class DataController {
    private $dbSet;
    public function __construct() {
        //TODO: use your database credentials
        $mySQL = new mysqli("localhost", "root", "", "liceu_test");
        $this->dbSet = new DbSet($mySQL, "liceu_db");
    }
